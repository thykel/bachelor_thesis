...
\projectinfo{
  ...
  abstract.en={This thesis describes principles and state of implementation of some new network architectures. It also documents implementation of the Relaying and Multiplexing Task module of one of the presented architectures, RINA, for the OMNeT++ simulation framework. The main goal of this thesis is to extend functionality of an existing simulation library to provide full-fledged means of modelling RINA networks.}, % abstrakt v anglickem jazyce
  %Prohlaseni
